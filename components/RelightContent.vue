<template>
    <section id="relight-info" class="bg-white py-16">
        <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="mb-20">
                <h2 v-motion :initial="{ opacity: 0, y: 40 }"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    ...
                    <div v-motion :initial="{ opacity: 0, y: 50, scale: 0.95 }"
                        ...
                        <p class="text-gray-600 leading-relaxed text-left">
                            ...
                            for $5 a month. Extra funds will help support the production of
            ...
            <div class="mb-20">
                <div class="grid lg:grid-cols-2 gap-12 items-start max-w-5xl mx-auto">
                    ...
                    <div v-motion :initial="{ opacity: 0, x: -50 }"
                        ...
                        <h3 v-motion :initial="{ opacity: 0, y: 30 }"
                        ...
                        <p v-motion :initial="{ opacity: 0, y: 20 }"
                            ...
                            this treatment to dozens, even hundreds, of reformed works. One day, we dream of offering
                            professional recordings of the most popular resources—and supporting this project can help
                            us get there.
                        </p>
                    ...
                    <div v-motion :initial="{ opacity: 0, x: 50, scale: 0.95 }"
                        ...
                        <div v-motion :initial="{ opacity: 0, scale: 0.8 }"
                            ...
                            <div class="flex justify-center items-center gap-4">
                                ...
                                <!-- Play/Pause Button -->
                                <button v-motion :initial="{ opacity: 0, scale: 0.8 }"
                                    ...
                                    <img v-if="!isPlaying" src="/Images/play.svg" alt="Play"
                                        class="w-6 h-6 filter brightness-0 invert" />
                                    <img v-else src="/Images/pause.svg" alt="Pause"
                                        class="w-6 h-6 filter brightness-0 invert" />
                                </button>
                            ...
                            <div v-motion :initial="{ opacity: 0, y: 20 }"
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <input v-model="playbackSpeed" @input="updatePlaybackSpeed" type="range" min="0.5"
                                        max="2" step="0.25"
                                ...
                                <span class="text-sm text-burgundy font-semibold min-w-[3rem]">{{ playbackSpeed
                                    }}x</span>
                            </div>
                        </div>
                    </div>
            ...
            <div v-motion :initial="{ opacity: 0, y: 40 }"
                ...
                <h2 v-motion :initial="{ opacity: 0, y: 20 }"
                ...
                <p v-motion :initial="{ opacity: 0, y: 15 }"
                    ...
                    <a href="https://www.youtube.com/watch?v=Y2N-vh1Bh0I" target="_blank" rel="noopener noreferrer"
                        class="text-burgundy hover:underline font-medium">learn more about Relight study.</a>
                </p>
            </div>

            <!-- Footnote Section -->
            <div v-motion :initial="{ opacity: 0, y: 20 }"
                :visible-once="{ opacity: 1, y: 0, transition: { delay: 680, duration: 480, ease: 'easeOut' } }"
                class="mt-16 pt-8 border-t border-gray-300">
                <p id="ai-voices-footnote" class="text-sm text-gray-500 leading-relaxed max-w-4xl mx-auto">
                    *The AI voices we use are all trained on permissive/non-copyrighted data—meaning data that was
                    acquired in the
                    public domain or under a license that permits use for training.
                </p>
            </div>
